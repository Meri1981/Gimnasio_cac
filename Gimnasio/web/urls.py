...
urlpatterns = [
    ...
    path("socio/eliminar/<int:idSocio>", views.eliminar_socio, name="eliminar_socio"),
    ...
    path("profesor/<int:idProfesor>/<int:eliminar>",views.crud_profesor, name="crud_profesor"),


    path("listado_inscripcion", InscripcionListView.as_view(), name="listado_inscripcion"),
    path("alta_inscripcion", InscripcionCreateView.as_view(), name="alta_inscripcion"),
    path("<int:pk>/editar_inscripcion",InscripcionUpdateView.as_view(),name="editar_inscripcion"),
    path("<int:pk>/eliminar_inscripcion/",InscripcionDeleteView.as_view(),name="eliminar_inscripcion"),

    
    path("accounts/login/", auth_views.LoginView.as_view(template_name="web/registration/login.html"), name="login"),
    path("accounts/logout/", auth_views.LogoutView.as_view(), name="logout"),
    path('accounts/password_reset/', auth_views.PasswordResetView.as_view(template_name='web/registration/password_reset.html',email_template_name='web/registration/password_reset_email.html',subject_template_name='web/registration/password_reset_subject.txt'), name='password_reset'),
